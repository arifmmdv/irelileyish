        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-jet-nav-link href="{{ route('section-types.show',1) }}">
                        Pages
                    </x-jet-nav-link>
                    <x-jet-nav-link href="{{ route('section-types.show',2) }}">
                        Slides
                    </x-jet-nav-link>
                    <x-jet-nav-link href="{{ route('languages.index') }}" :active="request()->routeIs('languages.index')">
                        Languages
                    </x-jet-nav-link>
                    <x-jet-nav-link href="{{ route('templates.index') }}" :active="request()->routeIs('templates.index')">
                        Templates
                    </x-jet-nav-link>
